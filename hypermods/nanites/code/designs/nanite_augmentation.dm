...
/datum/design/nanites/sticky_fingers
	...
	id = "stickyfingers_nanites"
	program_type = /datum/nanite_program/sticky_fingers
	category = list(NANITES_CATEGORY_AUGMENTATION)
...
/datum/design/nanites/antidismember
	...
	id = "antidismember_nanites"
	program_type = /datum/nanite_program/antidismember
	category = list(NANITES_CATEGORY_AUGMENTATION)
...
/datum/design/nanites/slipresist
	...
	id = "slipresist_nanites"
	program_type = /datum/nanite_program/slipresist
	category = list(NANITES_CATEGORY_AUGMENTATION)

/datum/design/nanites/magicshield
	...
	id = "magicshield_nanites"
	program_type = /datum/nanite_program/magicshield
	category = list(NANITES_CATEGORY_AUGMENTATION)

/datum/design/nanites/hardiness
	...
	id = "hardiness_nanites"
	program_type = /datum/nanite_program/hardiness
	category = list(NANITES_CATEGORY_AUGMENTATION)

/datum/design/nanites/antikpa
	...
	id = "antikpa_nanites"
	program_type = /datum/nanite_program/antikpa
	category = list(NANITES_CATEGORY_AUGMENTATION)
...
/datum/design/nanites/plantlike
	...
	id = "plantlike_nanites"
	program_type = /datum/nanite_program/plantlike
	category = list(NANITES_CATEGORY_AUGMENTATION)
