...
/obj/machinery/nanite_chamber
	...
	icon = 'hypermods/nanites/icons/nanite_machines.dmi'
	...
	var/chamber_icon = 'hypermods/nanites/icons/nanite_chamber.dmi'
...
/obj/machinery/nanite_chamber/proc/inject_nanites()
	...
	playsound(src, 'hypermods/nanites/sound/nanite_install.wav', 50)
...
/obj/machinery/nanite_chamber/proc/remove_nanites()
	...
	playsound(src, 'hypermods/nanites/sound/nanite_install_short.mp3', 50)
...
/obj/machinery/nanite_chamber/close_machine(atom/movable/target, density_to_set = TRUE)
	if(!state_open)
		return FALSE
	playsound(src, 'hypermods/nanites/sound/nanite_chamber.wav', 40)
	return ..()
