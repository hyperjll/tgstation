...
/obj/item/storage/fancy/cigarettes/space_cigarette_pen_acid
	...
	icon_state = "cig"
	base_icon_state = "cig"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/space_cigarette_pen_acid

/obj/item/storage/fancy/cigarettes/space_cigarette_pen_acid/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/space_cigarette_pen_acid(src)
...
/obj/item/storage/fancy/cigarettes/dromedary_oxandrolone
	...
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/dromedary_oxandrolone

/obj/item/storage/fancy/cigarettes/dromedary_oxandrolone/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/dromedary_oxandrolone(src)
...
/obj/item/storage/fancy/cigarettes/uplift_salbutamol
	...
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/uplift_salbutamol

/obj/item/storage/fancy/cigarettes/uplift_salbutamol/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/uplift_salbutamol(src)
...
/obj/item/storage/fancy/cigarettes/robust_sal_acid
	...
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/robust_sal_acid

/obj/item/storage/fancy/cigarettes/robust_sal_acid/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/robust_sal_acid(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_antibrute_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_antibrute_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_antibrute_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_antibrute_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_antiburn_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_antiburn_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_antiburn_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_antiburn_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_antioxygen_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_antioxygen_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_antioxygen_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_antioxygen_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_antitoxin_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_antitoxin_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_antitoxin_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_antitoxin_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_speedup_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_speedup_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_speedup_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_speedup_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_cureall_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_cureall_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_cureall_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_cureall_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_sensory_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_sensory_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_sensory_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_sensory_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_strange_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_strange_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_strange_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_strange_cigarette_pack(src)
...
/obj/item/storage/fancy/cigarettes/deluxe_slimey_cigarette_pack
	...
	icon_state = "robustg"
	base_icon_state = "robustg"
	spawn_type = /obj/item/clothing/mask/cigarette/syndicate/deluxe_slimey_cigarette_pack

/obj/item/storage/fancy/cigarettes/deluxe_slimey_cigarette_pack/PopulateContents()
	for(var/i in 1 to 6)
		new /obj/item/clothing/mask/cigarette/syndicate/deluxe_slimey_cigarette_pack(src)
