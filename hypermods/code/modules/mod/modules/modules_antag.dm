...
/obj/item/mod/module/adrenaline_boost/syndicate/on_use()
	...
	mod.wearer.adjust_stamina_loss(-20) // Down from 200
...
/obj/item/mod/module/death_sphere/proc/replace_fire_overlay(datum/source, stacks, on_fire, fire_icon, list/overrides)
	SIGNAL_HANDLER
