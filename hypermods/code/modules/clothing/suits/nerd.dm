...
/obj/item/clothing/suit/armor/nerd
	...
	var/static/list/wound_to_sound = list(
		/datum/wound/blunt/bone/severe = 'hypermods/sound/voice/nerdsuit/minor_fracture.ogg',
		/datum/wound/blunt/bone/critical = 'hypermods/sound/voice/nerdsuit/major_fracture.ogg',
		/datum/wound/loss = 'hypermods/sound/voice/nerdsuit/major_lacerations.ogg',
		/datum/wound/slash/flesh/severe = 'hypermods/sound/voice/nerdsuit/minor_lacerations.ogg',
		/datum/wound/slash/flesh/critical = 'hypermods/sound/voice/nerdsuit/major_lacerations.ogg',
	)
...
/obj/item/clothing/suit/armor/nerd/equipped(mob/M, slot)
	...
	if(slot == ITEM_SLOT_OCLOTHING && iscarbon(M))
		...
		add_queue('hypermods/sound/voice/nerdsuit/bell.ogg',2 SECONDS,purge_queue=TRUE)
		owner = M
		if(prob(1))
			add_queue('hypermods/sound/voice/nerdsuit/emag.ogg',27 SECONDS)
		else
			add_queue('hypermods/sound/voice/nerdsuit/welcome.ogg',8 SECONDS)
	else
		for(var/k in funny_signals)
...
/obj/item/clothing/suit/armor/nerd/proc/handle_ignite(mob/living)
	...
	add_queue('hypermods/sound/voice/nerdsuit/heat.ogg',3 SECONDS)
...
/obj/item/clothing/suit/armor/nerd/proc/handle_shock(mob/living)
	...
	SOUND_BEEP('hypermods/sound/voice/nerdsuit/beep_3.ogg')
	add_queue('hypermods/sound/voice/nerdsuit/shock.ogg',3 SECONDS)
...
/obj/item/clothing/suit/armor/nerd/proc/handle_wound_add(mob/living/carbon/C, datum/wound/W, obj/item/bodypart/L)
	...
	if(W.severity >= WOUND_SEVERITY_MODERATE)
		SOUND_BEEP('hypermods/sound/voice/nerdsuit/beep_3.ogg')
		add_queue('hypermods/sound/voice/nerdsuit/seek_medical.ogg',2 SECONDS)
		administer_morphine()
...
/obj/item/clothing/suit/armor/nerd/proc/handle_damage(mob/living/carbon/C, damage, damagetype, def_zone)
	...
	switch(health_percent)
		if(0.76 to INFINITY)
			return
		if(0.51 to 0.75)
			SOUND_BEEP('hypermods/sound/voice/nerdsuit/beep_2.ogg')
			add_queue('hypermods/sound/voice/nerdsuit/vital_signs_dropping.ogg',2 SECONDS)
			COOLDOWN_START(src, next_damage_notify, 5 SECONDS)
		if(0.26 to 0.50)
			SOUND_BEEP('hypermods/sound/voice/nerdsuit/beep_3.ogg')
			add_queue('hypermods/sound/voice/nerdsuit/vital_signs_critical.ogg',3 SECONDS)
			COOLDOWN_START(src, next_damage_notify, 5 SECONDS)
		else
			SOUND_BEEP('hypermods/sound/voice/nerdsuit/beep_3.ogg')
			add_queue('hypermods/sound/voice/nerdsuit/vital_signs_death.ogg',3 SECONDS)
			COOLDOWN_START(src, next_damage_notify, 5 SECONDS)
			administer_morphine()
