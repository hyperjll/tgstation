...
/obj/structure/drain
	name = "drain"
	icon = 'hypermods/icons/obj/structures/drains.dmi'
	icon_state = "drain"
...
/obj/structure/drain/process()
	if(!my_turf.liquids)
		...
		processing = FALSE
		return
	if(!length(my_turf.liquids.liquid_group))
		...
		playsound(my_turf, 'hypermods/sound/effects/liquids_drained.ogg', 20, 0)
