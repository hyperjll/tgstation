...
/datum/antagonist/vassal/proc/return_vassal_examine(mob/living/viewer)
	...
	if(master.owner == viewer.mind)
		...
		returnIcon = "[icon2html('hypermods/icons/bloodsuckers/vampiric.dmi', world, "vassal")]"
	// Am I someone ELSE'S Vassal?
		...
		returnIcon = "[icon2html('hypermods/icons/bloodsuckers/vampiric.dmi', world, "vassal_grey")]"
