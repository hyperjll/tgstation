...
/obj/structure/bloodsucker/vassalrack
	...
	icon = 'hypermods/icons/bloodsuckers/vamp_obj.dmi'
...
/obj/structure/bloodsucker/vassalrack/user_buckle_mob(mob/living/target, mob/user, check_loc = TRUE)
...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'hypermods/icons/bloodsuckers/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('hypermods/icons/bloodsuckers/vamp_obj_64.dmi', "thronearm")
