/datum/antagonist/bloodsucker/proc/claim_coffin(obj/structure/closet/crate/claimed, area/current_area)
	...
	if(!(/datum/crafting_recipe/vassalrack in owner?.learned_crafting_recipes))
...
/obj/structure/closet/crate/coffin/blackcoffin
	...
	open_sound = 'hypermods/sound/bloodsuckers/coffin_open.ogg'
	close_sound = 'hypermods/sound/bloodsuckers/coffin_close.ogg'
...
/obj/structure/closet/crate/coffin/can_open(mob/living/user)
	...
	if(user == resident)
		...
		locked = FALSE
		return TRUE
	playsound(get_turf(src), 'sound/machines/airlock/doorclick.ogg', 20, 1)
