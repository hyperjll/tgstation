...
/obj/item/stake
	...
	icon = 'hypermods/icons/bloodsuckers/stakes.dmi'
	icon_state = "wood"
	inhand_icon_state = "wood"
	lefthand_file = 'hypermods/icons/bloodsuckers/bs_leftinhand.dmi'
	righthand_file = 'hypermods/icons/bloodsuckers/bs_rightinhand.dmi'
	...
	embed_type = /datum/embedding/wooden_stake
	force = 6
	throwforce = 10
	max_integrity = 30
