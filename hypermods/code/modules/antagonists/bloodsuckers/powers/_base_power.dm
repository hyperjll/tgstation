/datum/action/cooldown/bloodsucker
	...
	background_icon = 'hypermods/icons/bloodsuckers/actions_bloodsucker.dmi'
	background_icon_state = "vamp_power_off"
	button_icon = 'hypermods/icons/bloodsuckers/actions_bloodsucker.dmi'
	...
	var/purchase_flags = NONE // BLOODSUCKER_CAN_BUY|BLOODSUCKER_DEFAULT_POWER|VASSAL_CAN_BUY
...
/datum/action/cooldown/bloodsucker/proc/can_use(mob/living/carbon/user, trigger_flags)
	...
	if((check_flags & BP_CANT_USE_WHILE_UNCONSCIOUS) && user.stat != STABLE)
...
/datum/action/cooldown/bloodsucker/process(seconds_per_tick)
	...
	if(!(power_flags & BP_AM_COSTLESS_UNCONSCIOUS) && owner.stat != STABLE)
		if(bloodsuckerdatum_power)
