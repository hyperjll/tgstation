...
/obj/structure/lattice/clockwork
	...
	icon = 'hypermods/icons/obj/clock_cult/lattice_clockwork.dmi'
...
/obj/structure/lattice/clockwork/ratvar_act()
	if(ISODD(x+y)) //this check looks to be broken
		icon = 'hypermods/icons/obj/clock_cult/lattice_clockwork_large.dmi'
		pixel_x = -9
		pixel_y = -9
	else
		icon = 'hypermods/icons/obj/clock_cult/lattice_clockwork.dmi'
...
/obj/structure/lattice/catwalk/clockwork
	...
	icon = 'hypermods/icons/obj/clock_cult/catwalk_clockwork.dmi'
...
/obj/structure/lattice/catwalk/clockwork/ratvar_act()
	if(ISODD(x+y))
		icon = 'hypermods/icons/obj/clock_cult/catwalk_clockwork_large.dmi'
		pixel_x = -9
		pixel_y = -9
	else
		icon = 'hypermods/icons/obj/clock_cult/catwalk_clockwork.dmi'
