/obj/vehicle/sealed/mecha/steam_helios
	...
	cell = /obj/item/stock_parts/power_store/cell/clock
	scanmod = /obj/item/stock_parts/scanning_module/triphasic/clock //walking is free
	capacitor = /obj/item/stock_parts/capacitor/quadratic/clock
	accesses = list(ACCESS_CLOCKCULT)
...
/datum/action/vehicle/sealed/mecha/judicial_mark
	name = "Judicial Mark"
	button_icon = 'hypermods/icons/mob/clock_cult/actions_clock.dmi'
