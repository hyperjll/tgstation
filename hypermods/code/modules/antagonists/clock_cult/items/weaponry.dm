...
/obj/item/clockwork/weapon
	...
	desc = "Something"
	icon = 'hypermods/icons/obj/clock_cult/clockwork_weapons.dmi'
	lefthand_file = 'hypermods/icons/mob/clock_cult/clockwork_lefthand.dmi'
	righthand_file = 'hypermods/icons/mob/clock_cult/clockwork_righthand.dmi'
...
/obj/item/clockwork/weapon/afterattack(mob/living/target, mob/user, proximity_flag, click_parameters)
	...
	if(!user.has_status_effect(/datum/status_effect/clockwork_tile))
		return
...
/datum/action/cooldown/spell/summon_spear
	...
	button_icon = 'hypermods/icons/obj/clock_cult/clockwork_weapons.dmi'
	button_icon_state = "ratvarian_spear0"
	background_icon = 'hypermods/icons/mob/clock_cult/background_clock.dmi'
...
/datum/action/cooldown/spell/summon_spear/can_cast_spell(feedback)
	...
	if(!owner.has_status_effect(/datum/status_effect/clockwork_tile))
		if(feedback)
...
/obj/item/gun/ballistic/bow/clockwork/handle_chamber(empty_chamber = TRUE, from_firing = TRUE, chamber_next_round = TRUE)
	var/obj/item/ammo_casing/casing = chambered //Find chambered round
	if(istype(casing) && QDELING(casing)) //there's a chambered round that's being qdel'd
		chambered = null
		return
	. = ..()
...
/obj/projectile/energy/clockbolt
	name = "energy bolt"
	icon = 'hypermods/icons/obj/clock_cult/projectiles.dmi'
