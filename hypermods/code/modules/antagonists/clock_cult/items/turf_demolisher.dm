...
/obj/item/turf_demolisher/interact_with_atom(atom/target, mob/user, proximity_flag, click_parameters)
	. = ..()
...
/obj/item/turf_demolisher/proc/try_demolish(turf/attacked_turf, mob/living/user)
	...
	playsound(src, 'sound/items/weapons/sonic_jackhammer.ogg', 80)
