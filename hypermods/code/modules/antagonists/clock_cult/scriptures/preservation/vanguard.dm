...
/datum/scripture/slab/vanguard/invoke()
	...
	invoker.add_movespeed_mod_immunities(type, /datum/movespeed_modifier/damage_slowdown)
...
/datum/scripture/slab/vanguard/end_invocation(silent)
	...
	invoker.remove_traits(list(TRAIT_STUNIMMUNE,
							   TRAIT_PUSHIMMUNE,
							   TRAIT_NOLIMBDISABLE), VANGUARD_TRAIT)
	invoker.remove_movespeed_mod_immunities(type, /datum/movespeed_modifier/damage_slowdown)
