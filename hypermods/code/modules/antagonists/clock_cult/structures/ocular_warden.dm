...
/obj/structure/destructible/clockwork/gear_base/powered/ocular_warden/process(delta_time)
	...
	playsound(src, 'hypermods/sound/machines/clockcult/ocularwarden_target.ogg', 60, TRUE)
	...
	playsound(target, 'hypermods/sound/machines/clockcult/ocularwarden_dot1.ogg', 60, TRUE)
