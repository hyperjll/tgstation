...
/obj/item/antag_spawner/securityborg
	...
	var/special_role_name = "Security Cyborg"
	/// Style used by the droppod
	var/pod_style = STYLE_STANDARD
	/// Where do we land our pod?
	var/turf/spawn_location

/obj/item/antag_spawner/securityborg/proc/check_usability(mob/user)
	if(used)
...
/obj/item/antag_spawner/securityborg/proc/setup_pod()
	var/obj/structure/closet/supplypod/pod = new(null, pod_style)
	pod.explosionSize = list(0,0,0,0)
	pod.bluespace = TRUE
	return pod

/obj/item/antag_spawner/securityborg/attack_self(mob/user)
...
/obj/item/antag_spawner/securityborg/spawn_antag(client/our_client, turf/T, kind, datum/mind/user)
