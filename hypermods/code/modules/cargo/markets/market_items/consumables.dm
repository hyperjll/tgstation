...
/datum/market_item/consumable/random_potions
	name = "Box of Potions"
	desc = "A box containing seven bottles of endless possibilities. Sponsored by the Wizard Federation"
	item = /obj/item/storage/box/alchemist_random_chems
