...
/datum/supply_pack/materials/clothsupply
	name = "50 Cloth Crate"
	desc = "50 sheets of Cloth. You can never have enough beds you know?"
	cost = 2000
...
/datum/supply_pack/materials/durathreadsupply
	name = "10 Durathread Crate"
	desc = "10 sheets of Durathread. Imagine what you could do with 500 of these crates."
	cost = 2000
	contains = list(/obj/item/stack/sheet/cotton/durathread,
					...
					/obj/item/stack/sheet/cotton/durathread,
					/obj/item/stack/sheet/cotton/durathread)
	crate_name = "durathread crate"
	crate_type = /obj/structure/closet/crate

/datum/supply_pack/materials/rglasssupply
	name = "50 Reinforced Glass Sheets Crate"
	desc = "50 sheets of reinforced glass sheets. For restocking the ore silo, or for building stronger windows."
	cost = 1600
	contains = list(/obj/item/stack/sheet/rglass/fifty)
	crate_name = "reinforced glass crate"
	crate_type = /obj/structure/closet/crate

/datum/supply_pack/materials/plasmaglasssupply
	name = "50 Plasma Glass Sheets Crate"
	desc = "50 sheets of plasma glass. For restocking the ore silo, or for building stronger windows."
	cost = 10000
	contains = list(/obj/item/stack/sheet/plasmaglass/fifty)
	crate_name = "plasma glass crate"
	crate_type = /obj/structure/closet/crate

/datum/supply_pack/materials/plasmarglasssupplytwenty
	name = "20 Reinforced Plasma Glass Sheets Crate"
	desc = "20 sheets of reinforced plasma glass. For restocking the ore silo, or for building incredibly strong see-through walls."
	cost = 10000
	contains = list(/obj/item/stack/sheet/plasmarglass/twenty)
	crate_name = "reinforced plasma glass crate"
	crate_type = /obj/structure/closet/crate

/datum/supply_pack/materials/plasmarglasssupply
	name = "50 Reinforced Plasma Glass Sheets Crate"
	desc = "50 sheets of reinforced plasma glass. For restocking the ore silo, or for building incredibly strong see-through walls."
	cost = 25000
	contains = list(/obj/item/stack/sheet/plasmarglass/fifty)
	crate_name = "reinforced plasma glass crate"
	crate_type = /obj/structure/closet/crate
...
/datum/supply_pack/materials/bluespace_crystalsupply
	name = "50 Bluspace Crystals Crate"
	desc = "50 bluespace crystals. For restocking the ore silo, in case of emergencies of course."
	cost = 10000
	contains = list(/obj/item/stack/sheet/bluespace_crystal/fifty)
	crate_name = "bluespace crystals crate"
	crate_type = /obj/structure/closet/crate
