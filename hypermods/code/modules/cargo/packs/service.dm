...
/datum/supply_pack/service/assistvending
	name = "Vendomat"
...
/datum/supply_pack/service/autodrobevending
	name = "Autodrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 1500
...
/datum/supply_pack/service/boozeomatvending
	name = "Booze-O-Mat"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 2000
...
/datum/supply_pack/service/cartvending
	name = "PTech"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 1500
...
/datum/supply_pack/service/cigarettevending
...
/datum/supply_pack/service/clothingvending
	name = "ClothesMate"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 2000
...
/datum/supply_pack/service/coffeevending
...
/datum/supply_pack/service/colavending
...
/**
/datum/supply_pack/service/prisoncolavending
...
**/
/datum/supply_pack/service/dinnerwarevending
...
/datum/supply_pack/service/engineeringvending
...
/datum/supply_pack/service/engivendvending
	name = "Engi-Vend"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 2500
...
/datum/supply_pack/service/gamesvending
	name = "Good Clean Fun"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 1500
...
/**
/datum/supply_pack/service/giftsvending
	name = "Gift Vendor"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 1500
...
**/
/datum/supply_pack/service/hydroseedsvending
...
/**
/datum/supply_pack/service/weakhydroseedsvending
...
**/
/datum/supply_pack/service/modularpcvending
...
/datum/supply_pack/service/hydronutrientsvending
	name = "NutriMax"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 2000
...
/datum/supply_pack/service/roboticsvending
...
/datum/supply_pack/service/securityvending
	name = "SecTech"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 5000
...
/**
/datum/supply_pack/service/randomsnackvending
...
**/
/datum/supply_pack/service/sovietsodavending
...
/datum/supply_pack/service/sustenancevending
...
/datum/supply_pack/service/toolvending
	name = "YouTool"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 2500
...
/**
/datum/supply_pack/service/fishingvending
...
**/
/datum/supply_pack/service/sec_wardrobe
	name = "SecDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/medi_wardrobe
	name = "MediDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/engi_wardrobe
	name = "EngiDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/atmos_wardrobe
	name = "AtmosDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/cargo_wardrobe
	name = "CargoDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/robo_wardrobe
	name = "RoboDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/science_wardrobe
	name = "SciDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/hydro_wardrobe
	name = "Hydrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/curator_wardrobe
	name = "CuraDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/bar_wardrobe
	name = "BarDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/chef_wardrobe
	name = "ChefDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/jani_wardrobe
	name = "JaniDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/law_wardrobe
	name = "LawDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/chap_wardrobe
	name = "ChapDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/chem_wardrobe
	name = "ChemDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/gene_wardrobe
	name = "GeneDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
...
/datum/supply_pack/service/viro_wardrobe
	name = "ViroDrobe"
	desc = "A crate containing a fully assembled vending machine, be sure to delay opening the crate until it's where you want the vending machine to be.."
	cost = 3000
