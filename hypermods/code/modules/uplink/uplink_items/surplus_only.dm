...
/datum/uplink_item/surplusonly/mythril
	name = "Mythril"
	desc = "Five bars of pure Mythril. From what little we've been able to study of it, this material has inheretly mystical properties. \
