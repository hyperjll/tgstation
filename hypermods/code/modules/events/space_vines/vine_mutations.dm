...
/datum/spacetendon_mutation/proc/add_mutation_to_vinepiece(obj/structure/spacetendons/holder)
	holder.mutations |= src
	holder.add_atom_colour(hue, FIXED_COLOUR_PRIORITY)

/datum/spacetendon_mutation/proc/process_mutation(obj/structure/spacetendons/holder)
	return

/datum/spacetendon_mutation/proc/on_birth(obj/structure/spacetendons/holder)
	return

/datum/spacetendon_mutation/proc/on_grow(obj/structure/spacetendons/holder)
	return

/datum/spacetendon_mutation/proc/on_death(obj/structure/spacetendons/holder)
	return

/datum/spacetendon_mutation/proc/on_hit(obj/structure/spacetendons/holder, mob/hitter, obj/item/item, expected_damage)
	. = expected_damage

/datum/spacetendon_mutation/proc/on_cross(obj/structure/spacetendons/holder, mob/crosser)
	return

/datum/spacetendon_mutation/proc/on_chem(obj/structure/spacetendons/holder, datum/reagent/chem)
	return

/datum/spacetendon_mutation/proc/on_eat(obj/structure/spacetendons/holder, mob/living/eater)
	return

/datum/spacetendon_mutation/proc/on_spread(obj/structure/spacetendons/holder, turf/target)
	return

/datum/spacetendon_mutation/proc/on_buckle(obj/structure/spacetendons/holder, mob/living/buckled)
	return

/datum/spacetendon_mutation/proc/on_explosion(severity, target, obj/structure/spacetendons/holder)
	return FALSE

/datum/spacetendon_mutation/proc/additional_atmos_processes(obj/structure/spacetendons/holder, datum/gas_mixture/air)
	return

/datum/spacetendon_mutation/aggressive_spread/proc/aggrospread_act(obj/structure/spacetendons/vine, mob/living/M)
	return

/datum/spacetendon_mutation/light
	name = "Light"
...
/datum/spacetendon_mutation/light/on_grow(obj/structure/spacetendons/holder)
	if(holder.growth_stage)
		holder.set_light(LIGHT_MUTATION_BRIGHTNESS, 0.3)

/datum/spacetendon_mutation/toxicity
	name = "Toxic"
...
/datum/spacetendon_mutation/toxicity/on_cross(obj/structure/spacetendons/holder, mob/living/crosser)
...
/datum/spacetendon_mutation/toxicity/on_eat(obj/structure/spacetendons/holder, mob/living/eater)
	if(!isvineimmune(eater))
		eater.adjustToxLoss(20)

/datum/spacetendon_mutation/explosive  // JC IT'S A BOMB
	name = "Explosive"
...
/datum/spacetendon_mutation/explosive/on_explosion(explosion_severity, target, obj/structure/spacetendons/holder)
...
/datum/spacetendon_mutation/explosive/on_death(obj/structure/spacetendons/holder, mob/hitter, obj/item/item)
	explosion(holder, light_impact_range = EXPLOSION_MUTATION_IMPACT_RADIUS, adminlog = FALSE)

/datum/spacetendon_mutation/fire_proof
	name = "Fire proof"
...
/datum/spacetendon_mutation/fire_proof/add_mutation_to_vinepiece(obj/structure/spacetendons/holder)
	. = ..()
	holder.trait_flags |= SPACEVINE_HEAT_RESISTANT

/datum/spacetendon_mutation/fire_proof/on_hit(obj/structure/spacetendons/holder, mob/hitter, obj/item/attacking_item, expected_damage)
	if(attacking_item && attacking_item.damtype == BURN)
		return 0
	return expected_damage

/datum/spacetendon_mutation/cold_proof
	name = "Cold proof"
...
/datum/spacetendon_mutation/cold_proof/add_mutation_to_vinepiece(obj/structure/spacetendons/holder)
	. = ..()
	holder.trait_flags |= SPACEVINE_COLD_RESISTANT

/datum/spacetendon_mutation/temp_stabilisation
...
/datum/spacetendon_mutation/temp_stabilisation/add_mutation_to_vinepiece(obj/structure/spacetendons/holder)
	. = ..()
	holder.always_atmos_process = TRUE

/datum/spacetendon_mutation/temp_stabilisation/additional_atmos_processes(obj/structure/spacetendons/holder, datum/gas_mixture/air)
...
/datum/spacetendon_mutation/vine_eating
	name = "Vine eating"
	description = "Destroys Kudzu vines on spread."
	hue = "#F4A442"
	quality = MINOR_NEGATIVE
	severity = SEVERITY_MINOR

/// Destroys any vine on spread-target's tile. The checks for if this should be done are in the spread() proc.
/datum/spacetendon_mutation/vine_eating/on_spread(obj/structure/spacetendons/holder, turf/target)
	for(var/obj/structure/spacevine/prey in target)
		qdel(prey)

/datum/spacetendon_mutation/aggressive_spread  //very OP, but im out of other ideas currently
...
/datum/spacetendon_mutation/aggressive_spread/on_spread(obj/structure/spacetendons/holder, turf/turf, mob/living)
...
/datum/spacetendon_mutation/aggressive_spread/on_buckle(obj/structure/spacetendons/holder, mob/living/buckled)
...
/datum/spacetendon_mutation/aggressive_spread/aggrospread_act(obj/structure/spacevine/vine, mob/living/living_mob)
	...
	if(istype(victim)) //If the mob (M) is a carbon subtype (C) we move on to pick a more complex damage proc, with damage zones, wounds and armor mitigation.
		...
		var/datum/spacetendon_mutation/thorns/thorn = locate() in vine.mutations //Searches for the thorns mutation in the "mutations"-list inside obj/structure/spacevine, and defines T if it finds it.
...
/datum/spacetendon_mutation/transparency
	name = "transparent"
...
/datum/spacetendon_mutation/transparency/on_birth(obj/structure/spacetendons/holder)
	holder.light_state = PASS_LIGHT
	holder.alpha = 125

/datum/spacetendon_mutation/oxy_eater
...
/datum/spacetendon_mutation/oxy_eater/process_mutation(obj/structure/spacetendons/holder)
...
/datum/spacetendon_mutation/nitro_eater
...
/datum/spacetendon_mutation/nitro_eater/process_mutation(obj/structure/spacetendons/holder)
	var/turf/open/floor/turf = holder.loc
	if(istype(turf))
		var/datum/gas_mixture/gas_mix = turf.air
...
/datum/spacetendon_mutation/carbondioxide_eater
	name = "CO2 consuming"
...
/datum/spacetendon_mutation/carbondioxide_eater/process_mutation(obj/structure/spacetendons/holder)
	var/turf/open/floor/turf = holder.loc
	if(istype(turf))
		var/datum/gas_mixture/gas_mix = turf.air
...
/datum/spacetendon_mutation/plasma_eater
...
/datum/spacetendon_mutation/plasma_eater/process_mutation(obj/structure/spacetendons/holder)
	var/turf/open/floor/turf = holder.loc
	if(istype(turf))
		var/datum/gas_mixture/gas_mix = turf.air
...
/datum/spacetendon_mutation/thorns
	name = "Thorny"
...
/datum/spacetendon_mutation/thorns/on_cross(obj/structure/spacetendons/holder, mob/living/crosser)
...
/datum/spacetendon_mutation/thorns/on_hit(obj/structure/spacetendons/holder, mob/living/hitter, obj/item/item, expected_damage)
	if(iscarbon(hitter))
...
/datum/spacetendon_mutation/hardened
	name = "Hardened"
...
/datum/spacetendon_mutation/hardened/on_grow(obj/structure/spacetendons/holder)
	if(holder.growth_stage)
		holder.set_density(TRUE)
	holder.modify_max_integrity(100)

/datum/spacetendon_mutation/hardened/on_hit(obj/structure/spacetendons/holder, mob/living/hitter, obj/item/item, expected_damage)
	if(item?.get_sharpness())
		return expected_damage * 0.5
	return expected_damage

/datum/spacetendon_mutation/timid
	name = "Timid"
...
/datum/spacetendon_mutation/timid/on_birth(obj/structure/spacetendons/holder)
	SET_PLANE_IMPLICIT(holder, FLOOR_PLANE)
	holder.layer = ABOVE_OPEN_TURF_LAYER
	holder.light_state = PASS_LIGHT
	holder.can_tangle = FALSE
	return ..()
/** // Don't really want meatzu to flower right now.
/datum/spacetendon_mutation/flowering
	name = "Flowering"
...
/datum/spacetendon_mutation/flowering/on_grow(obj/structure/spacetendons/holder)
...
/datum/spacetendon_mutation/flowering/on_cross(obj/structure/spacetendons/holder, mob/living/crosser)
	if(prob(25))
