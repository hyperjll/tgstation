/obj/machinery/vending/gifts
	...
	products = list(/obj/item/toy/heartballoon = 3,
					...
					/obj/item/reagent_containers/applicator/patch/styptic = 2,
					/obj/item/reagent_containers/applicator/patch/silver_sulf = 2,
	...
	premium = list(/obj/item/choice_beacon_cooldown = 5)
