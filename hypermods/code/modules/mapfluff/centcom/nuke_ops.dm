...
/obj/item/keycard/syndicate_nanite
	name = "Syndicate Nanite Lab Access Card"
	desc = "A red keycard with an image of a nano-bot. Using this will allow you to gain access to the Nanite Lab in Firebase Balthazord."
	color = "#ff1717"
	puzzle_id = "syndicate_nanite"
...
/obj/machinery/door/puzzle/keycard/syndicate_nanite
