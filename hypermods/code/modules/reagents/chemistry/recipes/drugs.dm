...
/datum/chemical_reaction/opium
	...
	required_reagents = list(/datum/reagent/drug/painkillers = 2, /datum/reagent/medicine/morphine = 1)
...
/datum/chemical_reaction/heroin
	...
	required_reagents = list(/datum/reagent/drug/opium = 2, /datum/reagent/drug/space_drugs = 1, /datum/reagent/oxygen = 1)
	reaction_tags = REACTION_TAG_OTHER | REACTION_TAG_HEALING | REACTION_TAG_DRUG
