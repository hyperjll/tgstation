/obj/item/reagent_containers/cup/jerrycan/random
	...
	/// Reagents we REALLY don't want to give out. Things like romerol have a higher chance of rolling due to multiple reagent rolls, and some have runtime bugs.
	var/list/blocked_reagents = list(/datum/reagent/romerol, /datum/reagent/nitrium_high_metabolization, /datum/reagent/nitrium_low_metabolization)
