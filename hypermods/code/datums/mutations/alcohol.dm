/datum/mutation/alcohol_tolerance
...
/datum/mutation/alcohol_tolerance/on_acquiring(mob/living/carbon/human/owner)
	. = ..()
	if(!.)
		return
...
/datum/mutation/alcohol_tolerance/on_losing(mob/living/carbon/human/owner)
	. = ..()
	if(.)
		return
