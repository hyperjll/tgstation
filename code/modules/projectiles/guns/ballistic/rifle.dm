...
/obj/item/gun/ballistic/rifle/sks
	...
	desc = "A revival of the ancient SKS semi-automatic rifle, redesigned to utilize 7.62mm rounds. Produced to celebrate the \
...
/obj/item/gun/ballistic/rifle/sks/chekhov
	...
	desc = "A revival of the ancient SKS semi-automatic rifle, redesigned to utilize 7.62mm rounds. The name \
