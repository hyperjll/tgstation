...
/datum/revolution_handler/proc/declare_revs_win()
	...
	SSdynamic.try_spawn_midround(HEAVY_MIDROUND) // The station has been completely de-stabilized, anyone within the sector's going to want to captialize on that
