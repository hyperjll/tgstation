...
/proc/electrocute_mob(mob/living/carbon/victim, power_source, obj/source, siemens_coeff = 1, dist_check = FALSE, always_shock = FALSE)
	...
	if(victim.get_item_by_slot(ITEM_SLOT_GLOVES)?.siemens_coefficient == 0 && !always_shock)
