...
/obj/machinery/vending/medical/syndicate/cybersun
	...
	products = list(
		...
		/obj/item/reagent_containers/applicator/patch/styptic_powder = 5,
		/obj/item/reagent_containers/applicator/patch/aiuri = 5,
		/obj/item/reagent_containers/applicator/patch/silver_sulfadiazine = 5,
		...
		/obj/item/reagent_containers/medigel/styptic_powder = 2,
		/obj/item/reagent_containers/medigel/aiuri = 2,
		/obj/item/reagent_containers/medigel/silver_sulfadiazine = 2,
		/obj/item/reagent_containers/medigel/sterilizine = 1,
		/obj/item/storage/pill_bottle/inaprovaline = 3,
		/obj/item/storage/pill_bottle/painkillers = 5,
		/obj/item/reagent_containers/syringe/contraband/opium = 5,
	)
	contraband = list(/obj/item/reagent_containers/cup/bottle/cold = 2,
		...
		/obj/item/reagent_containers/syringe/contraband/heroin = 2,
	)
	premium = list(
		/obj/item/storage/pill_bottle/psicodine = 2,
		/obj/item/storage/pill_bottle/antidepressant = 2,
