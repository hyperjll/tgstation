...
/datum/uplink_item/weapon_kits/core
	...
	cost = (/datum/uplink_item/mobility/doorjack::cost + /datum/uplink_item/implants/freedom::cost + /datum/uplink_item/explosive_tools/c4::cost + /datum/uplink_item/consumable/stimpack::cost +	/datum/uplink_item/mod_modules/energy_shield::cost)
	limited_stock = 1
	cant_discount = TRUE
	purchasable_from = UPLINK_SERIOUS_OPS
