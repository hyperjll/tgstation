...
/obj/item/storage/medkit
	...
	/// If this medkit can be replaced with a varient on spawn, specify it's typepath here, leave null for no varient.
	var/possible_alt = null
	/// Chance to replace with other item listed above.
	var/alt_chance = 10
...
/obj/item/storage/medkit/advanced/PopulateContents()
	...
	return flatten_quantified_list(list(
		...
		/obj/item/reagent_containers/medigel/synthflesh/big,
