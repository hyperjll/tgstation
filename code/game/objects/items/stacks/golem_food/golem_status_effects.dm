...
/datum/status_effect/golem/plasma
	...
	mineral_name = "plasma"
	applied_fluff = "Plasma sprout from your body. You're a walking bomb now. Be careful to avoid fires."
...
/// When we take fire damage (or... technically also cold damage, we don't differentiate), blow the fuck up.
