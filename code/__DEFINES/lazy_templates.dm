...
#define LAZY_TEMPLATE_KEY_REEBE "LT_REEBE"
#define LAZY_TEMPLATE_KEY_COMMANDOBASE "LT_COMMANDOBASE"
#define LAZY_TEMPLATE_KEY_SYNDICATE_SATELLITE "LT_SYNDICATESATELLITE"
...
#define LAZY_TEMPLATE_KEY_LIST_ALL(...) list( \
	...
	"City of Cogs" = LAZY_TEMPLATE_KEY_REEBE, \
	"Commando Base" = LAZY_TEMPLATE_KEY_COMMANDOBASE, \
	"Syndicate Satellite" = LAZY_TEMPLATE_KEY_SYNDICATE_SATELLITE, \
)
